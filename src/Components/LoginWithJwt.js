...
function LoginJwt() {
    ...
    async function onlogin(e){
        ...
        .then(function (res) {
            ...
            .then((result) => {
                setLogin(true)
              localStorage.setItem('login', JSON.stringify({ login: login, token: result.token }))
              console.warn(result);
    ...
    // function postman(e) {
    //     let token = "Bearer " + login.token;
    //     fetch("http://localhost:4700/api/posts",
    //       {
    //         headers: {
    //           'Authorization': token,
    //         },
                        ...
                        <div className="col-lg-6">
                            <div className="p-5">
                                ...
                                <form className="user">
                                    ...
                                    {/* <button onClick={ postman }>Make A Post</button> */}
                                    {/* {post} */}
                                    <hr/>
                                </form>
