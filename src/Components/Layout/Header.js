    ...
    <>
      ...
      >
        <div className="container d-flex align-items-center justify-content-between">
          ...
          <input type='text' value={text} placeholder='enter your city' id='' onChange={handleText} required />
          <Button variant="primary" type="button" onClick={handleSearch}><span>Search</span></Button>
          <nav id="navbar" className="navbar nav-link">
            <ul>
              ...
              <li>
                <a href="#chefs" value={valueContext.city} onClick={handleCity}>Providers</a>
              </li>
